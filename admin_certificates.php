...
/* Sidebar */
.sidebar { width:285px; flex-shrink:0; background:linear-gradient(180deg,#0f172a,#172554); color:#fff; padding:24px 18px; position:sticky; top:0; height:100vh; overflow-y:auto; display:flex; flex-direction:column; transition:width .3s,padding .3s,min-width .3s; }
