...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width:991px) { .app-shell { flex-direction: column; } .sidebar { width: 100%; height: auto; position: relative; } .main { padding: 16px; } .stats-row{grid-template-columns:1fr 1fr;} }
...
<aside class="sidebar">
  <div class="sidebar-top-area">
    ...
    <div class="nav-custom">
      ...
      <a href="teacher_monthly_earnings.php" class="nav-link-custom active">
