    ...
    <main class="main-content">
      <div class="topbar">
        ...
        <div class="admin-badge">
          <?= t('hello') ?>, <?php echo htmlspecialchars($adminName); ?>
        </div>
      </div>
      ...
      <section class="small-box-grid">
        <div class="mini-stat-card">
          <div class="mini-stat-title"><?= t('teacher_earn') ?></div>
          <p class="mini-stat-value">$<?php echo number_format($totalEarnings, 2); ?></p>
        </div>

        <div class="mini-stat-card">
          <div class="mini-stat-title"><?= t('avail_slots') ?></div>
          <p class="mini-stat-value"><?php echo $totalAvailableSlots; ?></p>
        </div>

        <div class="mini-stat-card">
          <div class="mini-stat-title"><?= t('today_slots') ?></div>
          <p class="mini-stat-value"><?php echo $todayAvailableSlots; ?></p>
        </div>

        <div class="mini-stat-card">
          <div class="mini-stat-title"><?= t('system_status') ?></div>
          <p class="mini-stat-value" style="font-size:1.3rem;"><?= t('active') ?></p>
        </div>
      </section>
      ...
      <section class="content-grid">
        <div class="panel-card">
          <div class="panel-header">
            ...
            <a href="manage_users.php" class="panel-link"><?= t('view_all') ?></a>
          </div>
        ...
        <div class="panel-card">
          <div class="panel-header">
            <h2 class="panel-title"><?= t('recent_earn') ?></h2>
            <a href="teacher_earnings.php" class="panel-link"><?= t('view_all') ?></a>
          </div>
      ...
      <section class="panel-card" style="margin-top:20px;">
        <div class="panel-header">
          <h2 class="panel-title"><?= t('upcoming_avail') ?></h2>
          <a href="available_slots.php" class="panel-link"><?= t('view_all') ?></a>
        </div>
